...
# Codex event stream persistence (stores raw `codex exec --json` output under WORKSPACE_ROOT/<task_id>/)
CODEX_PERSIST_EVENT_STREAM = _env_bool("CODEX_PERSIST_EVENT_STREAM", "false")
CODEX_EVENT_STREAM_FILENAME = os.getenv(
    "CODEX_EVENT_STREAM_FILENAME", "codex-events.jsonl"
)
CODEX_STDERR_FILENAME = os.getenv("CODEX_STDERR_FILENAME", "codex-stderr.log")
