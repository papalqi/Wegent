...
- [Codex Shell 对齐矩阵](./guides/developer/codex-shell-parity.md) - Codex 范围合同（对齐 ClaudeCode）
- [Codex Shell 运行时决策](./guides/developer/codex-shell-runtime.md) - 运行时选型与容器 PoC
